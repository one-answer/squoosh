...
export const siteOrigin = (() => {
  ...
  if (process.env.CONTEXT === 'production') return 'https://tinyimg.aolifu.org';
  if (process.env.DEPLOY_PRIME_URL) return process.env.DEPLOY_PRIME_URL;
  console.warn(
    'Unable to determine site origin, defaulting to https://tinyimg.aolifu.org',
  );
  return 'https://tinyimg.aolifu.org';
})();
